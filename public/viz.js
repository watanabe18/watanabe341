...
function vizInit() {
	...
	// in the html file.
	chart = new google.visualization.ColumnChart(document.getElementById('ex0'));                                                                                                  chart = new google.visualization.ColumnChart(document.getElementById('ex0'));
...
function vizController(thisYear) {
	...
	// Draw the chart for the listed academic year.
	chart.draw(views[thisYear].toDataTable(), options);
